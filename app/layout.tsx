...
import DesktopHeader from "@/components/desktopheader"; // ✅ correct case
          ...
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6 flex items-center justify-between py-3">
            ...
            <Link href="/" className="flex items-center gap-2 font-bold group">
              ...
              <span className="inline-flex items-baseline gap-1">
                ...
                <span className="text-amber-400 group-hover:opacity-90 transition">Designs</span>
                <span className="text-amber-400">&amp; Acoustics</span>
              </span>
            </Link>
